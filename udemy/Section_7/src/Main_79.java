...
//. account number . account balance · customer name · email · phone number
...
//In addition to this class, you'll set up a Main class, with a main method, that creates at least
//one instance of the Bank Account class, and simulates depositing and withdrawing money from the account.
public class Main_79 {
    public static void main(String[] args) {
        ...
        bobsAccount.setCustomerName("Sdjd Sdsd");
        bobsAccount.setCustomerEmail("fdjhfu@fjdnj.com");
        bobsAccount.setCustomerPhone("485454454856");
